...
function ConfirmService({navigation}) {
            ...
            <Content contentContainerStyle={[styles.bgFullWidth ]}>
                ...
                <View style={[styles.position_R , styles.bgFullWidth,
                    ...
                    <View style={[styles.Width_100 , styles.paddingHorizontal_30 , styles.marginBottom_50]}>
                        ...
                        <Text style={[styles.textBold , styles.text_black , styles.textSize_18 , styles.marginBottom_5 , styles.alignStart]}>{ i18n.t('confirmService') }</Text>
                    </View>
